...
<body>
    ...
    <nav class="glass-nav">
        <div class="logo">
            <img src="assets/img/logo.png" alt="Logo Portfolio" class="logo-img">
            <span>PORTFOLIO.</span>
        </div>
    ...
    <header id="hero" class="hero-section">
        ...
        <div class="hero-image reveal delay-200">
            <img src="assets/img/work.jpeg" alt="Espace de travail créatif" class="placeholder-img">
        </div>
    </header>
            ...
            <div class="about-grid">
                <div class="about-image reveal">
                    <div class="image-wrapper">
                        <img src="assets/img/photoprofil.jpg" alt="Photo de profil" class="placeholder-img">
                    </div>
                </div>
